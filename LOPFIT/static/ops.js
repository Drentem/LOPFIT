...
function settingsDialog (modalConatiner){
  ...
  settings_HTML += '<option value="space">Space</option>'
  settings_HTML += '<option value="tab">Tab</option>'
  settings_HTML += '<option value="enter">Enter</option>'
  settings_HTML += '<option value="disabled">Disabled</option>'
